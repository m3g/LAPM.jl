...
This package contains the validation scripts, reference datasets, and analysis code used to benchmark the Auton–Bolen (AB), Moeser–Horinek (MH), and Accessibility implementations available in [PDBTools.jl](https://m3g.github.io/PDBTools.jl).

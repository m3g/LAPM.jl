...
```julia
plot_MH_vs_AB("urea"; m1=MoeserHorinek, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("urea"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("tmao"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("sarcosine"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("proline"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("sorbitol"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("sucrose"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("betaine"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("glycerol"; m1=AutonBolen, m2=Accessibility)
```
...
```julia
plot_MH_vs_AB("trehalose"; m1=AutonBolen, m2=Accessibility)
```
